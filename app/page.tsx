    ...
    timerID = setInterval(() => {
      setCurrentAge((age) => {
        ...
        if (isImmortalCultivation && newAge === nextTribulationAge && nextTribulationAge > 0) {
          ...
          const successRate = Math.max(0.05, Math.min(0.95, baseSuccessRate - tribulationPenalty + attrBonus));
          
          console.log(`渡劫计算 - 基础成功率: ${baseSuccessRate}, 渡劫次数惩罚: ${tribulationPenalty}, 属性加成: ${attrBonus}, 最终成功率: ${successRate}`);
